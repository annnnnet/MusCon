...
import "./main.css";
import "../../basic.css";
import logo from "../../pics/logo3.gif";
          ...
          <div className="row">
            ...
            <div className="col-sm-6">
              <div className="main_text">
                ...
                <b><p id="main_text_2">music taste</p></b>
                <p id="main_text_3">make friends</p>
                <p id="main_text_4">for you</p>
              </div>
              <div className="main_buttons">
                <button type="button" class="main_vertical_button_right">
                  Log in
                </button>
                <br></br>
                <button type="button" class="main_vertical_button_left">
                  Sign up
                </button>
                <div className="main_horizontal_buttons">
                  <button type="button" className="main_horizontal_button">
                    <svg

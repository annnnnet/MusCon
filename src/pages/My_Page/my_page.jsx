              ...
              <div className="content">
                ...
                <div class="left violet_back body ">
                    ...
                    <div class=" col-sm-10 ava_reg canva">
                        ...
                        <a href="#" role="button" class="edit col-sm-8 text-capitalize btn "><ImPencil/> Edit profile </a>
                    </div>
                    </div>
            </div >
                                ...
                                {songs.map((item, index) => {
                                    return (
                                        <div class="col-sm-12 row ">
                                            <h4 class="col-sm-10 element song" href="/{items}">{item}</h4><button type="button" class=" col-sm-2 right delete_2 btn-close" aria-label="Close"></button></div>) 
                                                })}
                                </div>
                            </div>
                            </div>
                                        ...
                                        {genres.map((item, index) => {
                                            return (
                                                <div class="left col-sm-12 row  ">
                                                    <h4 class="col-sm-10 element genre" href="/{items}">{item}</h4><button type="button" class=" col-sm-2 right delete_2 btn-close" aria-label="Close"></button>
                                                </div>) 
                                        })}
                                    </div>
                                </div>
